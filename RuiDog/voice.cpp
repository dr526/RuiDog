...
void Voice::onReadyRead(){
    ...
    {
        //://img/loginBg.jpg
        this->setStyleSheet("border-image: url(:/img/voice0.png);");
    }
    else if(i%40>=10 && i%40<=19)
    {
        this->setStyleSheet("border-image: url(:/img/voice1.png);");
    }
    else if(i%40>=20 && i%40<=29)
    {
        this->setStyleSheet("border-image: url(:/img/voice2.png);");
    }
    else
    {
        this->setStyleSheet("border-image: url(:/img/voice3.png);");
    }
    i++;
